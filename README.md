...
This document provides an overview of each PHP file within the `framework` directory, detailing its purpose, relationships with other files, and key functions and fields.
